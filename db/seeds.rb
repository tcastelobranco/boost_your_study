...
", descricao_completa: "Licenciada em Gestão pela Nova School of Business and Economics
Salesianos de Lisboa e Escola Secundária D. Filipa de Lencastre| Curso de Ciências Socioeconómicas (Média final: 17/20)
A Carminho, este ano, estagiou na promotora de Festivais de Música - Música no Coração
...
", descricao_completa: "4.º ano da Licenciatura em Direito da Faculdade de Direito da Universidade Católica Portuguesa
Escola Secundária Rainha Dona Amélia | Curso de Ciências Socioeconómicas (Média final: 15/20)
A Catarina, recentemente, foi 3 semanas para a Guiné e animou um campo de férias de inclusão para os deficientes
Interesses: Voluntariado, Pintar, Ténis
")
...
", descricao_completa: "2.º ano da Licenciatura em Ciência Política e Relações Internacionais da Universidade Nova de Lisboa – FCSH
Escola Alemã de Lisboa, St. Timothy’s School (EUA) e Escola Secundária Pedro Nunes | Curso de Ciências Socioeconómicas (Média final: 17/20)
A Francisca estagiou no Jornal i e no Hotel Schloss Lübbennau (Alemanha)
Interesses: Línguas, Desporto, Filosofia, Comida, Cães
")
...
", descricao_completa: "2º ano da licenciatura em Engenharia Biomédica do Instituto Superior Técnico da Universidade de Lisboa
Salesianos de Lisboa | Curso de Ciências e Tecnologia (Média final: 20/20)
A Francisca, inicialmente, chegou a fazer um semestre em Medicina na Faculdade de Medicina da Universidade de Lisboa
Atualmente, lidera o Thirst Project no Instituto Superior Técnico da Universidade de Lisboa
Interesses: Viajar, Desporto, Andar de Barco, Animais
")
...
", descricao_completa: "Licenciada em Engenharia e Gestão Industrial pelo Instituto Superior Técnico da Universidade de Lisboa
Salesianos de Lisboa | Curso de Ciências e Tecnologia (Média final: 17/20)
A Inês, neste momento, está a concluir o Mestrado em Engenharia e Gestão Industrial no Instituto Superior Técnico da Universidade de Lisboa
A Inês estagiou na Unilever e na Sumol+Compal
Interesses: Viajar, Volley
")
...
", descricao_completa: "Licenciado em Economia pela Nova School of Business and Economics
Colégio São João de Brito e Escola Secundária do Restelo | Curso de Ciências Socioeconómicas (Média final: 17/20)
O João fez um Gap Year na Austrália e, neste momento, está a frequentar o Mestrado em Finanças na Nova School of Business and Economics
O João estagiou na Société Général, no Haitong Bank e no Grupo CIMD
Interesses: Viajar, Desporto
")
...
Áreas: Direito", descricao_completa: "Licenciado em Direito pela Faculdade de Direito da Universidade de Lisboa
Salesianos de Lisboa | Curso de Ciências Socioeconómicas (Média final: 17/20)
O Joaquim, neste momento, está a preparar a sua admissão na Ordem dos Advogados
O Joaquim, durante este ano, estagiou na Linklaters LLP, nas áreas de Corporate Finance e Banking & Projects
Interesses: Viajar, Livros, Cinema, Futebol
")
...
", descricao_completa: "Licenciado em História pela Faculdade de Letras da Universidade do Porto
Instituto de Desenvolvimento da Educação no Porto | Curso de Ciências Socioeconómicas (Média final: 15/20)
O Manuel, neste momento, está a frequentar o Mestrado em Ensino de História na Universidade Nova de Lisboa – FCSH
O Manuel foi Monitor da Universidade Júnior (Porto), na área de História e já foi monitor de diversos campos de férias, tendo trabalhado com crianças e jovens
Interesses: Estar com os Amigos, Viajar, Voluntariado, Museus, Festivais
")
...
Áreas: Matemática e Economia
", descricao_completa: "Licenciada em Economia pela Nova School of Business and Economics
Colégio São João de Brito| Curso de Ciências Socioeconómicas (Média final: 18/20)
A Maria Ana, neste momento, está a frequentar o Mestrado em Finanças na Nova School of Business and Economics
A Maria Ana, recentemente, estagiou no ComparaJá, uma startup de financial technology 
Interesses: Desenhar, Viajar, Cozinhar
")
...
", descricao_completa: "Licenciado em Engenharia Física Tecnológica pelo Instituto Superior Técnico da Universidade de Lisboa
Escola Secundária Pedro Nunes| Curso de Ciências e Tecnologia (Média final: 18/20)
O Pedro, neste momento, está a frequentar o Mestrado em Engenharia Física Tecnológica no Instituto Superior Técnico da Universidade de Lisboa e, ao mesmo tempo, uma segunda licenciatura em Estudos Clássicos na Faculdade de Letras da Universidade de Lisboa
...
", descricao_completa: "3º ano da licenciatura em Gestão na Universidade Católica Portuguesa
Salesianos de Lisboa | Curso de Ciências Socioeconómicas (Média final: 16/20)
O Pedro estagiou na MSTF Partners e, atualmente, trabalha na empresa IMPEC
Interesses: Viajar, Surf
")
...
", descricao_completa: "Licenciado em Engenharia Mecânica pelo Instituto Superior Técnico da Universidade de Lisboa
Escola Secundária Rainha Dona Leonor| Curso de Ciências e Tecnologia (Média final: 17/20)
O Ricardo, neste momento, está a concluir o Mestrado em Engenharia e Gestão Industrial no Instituto Superior Técnico da Universidade de Lisboa
Na sua tese final de Mestrado está a trabalhar com a Greenyard Logistics Portugal, num projeto relacionado com a sustentabilidade nas cadeias de abastecimento agroalimentares
Interesses: Viajar, Desporto ")
...
", descricao_completa: "1.º ano da licenciatura em Direito na Faculdade de Direito da Universidade de Lisboa
Escola Secundária Pedro Nunes| Curso de Ciências Socioeconómicas (Média final: 16/20)
A Rita anima CAMTIL e é voluntária no JRS-Jesuit Refugee Service, tendo, nesse âmbito, apoiado refugiados sírios em situações de vulnerabilidade social, através do ensino da Língua Portuguesa
Interesses: Música, Voluntariado, Campos de Férias, Literatura, Viajar
")
...
", descricao_completa: "Licenciado em Línguas, Literaturas e Culturas pela Faculdade de Letras da Universidade de Lisboa
Colégio São João de Brito| Curso de Línguas e Humanidades (Média final: 18/20)
O Sebastião, o ano passado, fez Erasmus na Universidade de Cambridge e, este ano, está no processo de se candidatar para um Mestrado na University College London
O Sebastião estagiou na editora By the Book
Interesses: Viajar, Cinema, Poesia, Teatro
")
...
", descricao_completa: "4.º ano da Licenciatura em Direito da Faculdade de Direito da Universidade Católica Portuguesa
Colégio São João de Brito| Curso de Ciências e Tecnologia (Média final: 17/20)
A Teresa, recentemente, realizou um estágio de verão na Morais Leitão, Galvão Teles, Soares da Silva & Associados e na Campos Ferreira, Sá Carneiro & Associados
Interesses: Viajar, Campos de Férias, Fotografia, Montar a Cavalo
")
...
Áreas: Matemática
", descricao_completa: "2.º ano da Licenciatura em Engenharia Informática na Faculdade de Ciências da Universidade de Lisboa
Salesianos de Lisboa | Curso de Ciências Socioeconómicas (Média final: 16/20)
O Tomás, este ano, realizou um estágio de verão na Codacy, empresa vencedora da Web Summit em 2014
O Tomás, recentemente, realizou também um curso avançado de Excel e de Macros e VBA no Instituto Superior Técnico da Universidade de Lisboa
...
AreaDisciplinaExplicador.create(area_disciplina_id: 26, explicador_id: 2)
# historia secundario
AreaDisciplinaExplicador.create(area_disciplina_id: 27, explicador_id: 1)
AreaDisciplinaExplicador.create(area_disciplina_id: 27, explicador_id: 10)
AreaDisciplinaExplicador.create(area_disciplina_id: 27, explicador_id: 15)
AreaDisciplinaExplicador.create(area_disciplina_id: 27, explicador_id: 16)
# ingles secundario
